...
namespace University.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,Grade,CourseID,StudentID,Enabled")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentID,Grade,CourseID,StudentID,Enabled")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
